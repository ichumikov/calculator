...
{
    std::string sql = "INSERT INTO calculations (first_value, second_value, operation, result, status) VALUES (" + std::to_string(task.firstValue) + ", " + std::to_string(task.secondValue) + ", '" + task.operation + "', " + std::to_string(task.result) + ", " + std::to_string(task.status) + ")";
